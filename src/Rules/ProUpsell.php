...
final class ProUpsell
{
    ...
    public function enabled(): bool
    {
        ...
        if (defined('Minimum\\Pro\\VERSION')) {
            return false;
        }
        /**
         * Filters whether the Sojlo PRO promo is shown on the settings screen.
         *
    ...
    private function url(): string
    {
         ...
         *
         * @param string $url Default the Sojlo PRO page.
         */
    ...
    private function priceLabel(): string
    {
        ...
        if (! empty($d['price_from'])) {
            ...
            return sprintf(__('from %1$s%2$d/yr', 'sojlo'), $cur, (int) $d['price_from']);
        }
        return '';
    }
    ...
    public function handleDismiss(): void
    {
        if (! current_user_can('manage_woocommerce')) {
            wp_die(esc_html__('Permission denied.', 'sojlo'));
        }
    ...
    public function banner(): void
    {
        ...
        $name     = (string) ($this->data()['name'] ?? 'Sojlo Pro');
        ...
        <div class="minimum-pro-banner" role="note">
            ...
            <p class="minimum-pro-banner__text">
                ...
                printf(esc_html__('Do more with %s', 'sojlo'), esc_html($name)); ?></strong>
            ...
            <a class="minimum-pro-banner__dismiss" href="<?php echo esc_url($this->dismissUrl()); ?>" aria-label="<?php esc_attr_e('Dismiss this notice', 'sojlo'); ?>">&times;</a>
        </div>
        <?php
    }
    ...
    public function aside(): void
    {
        ...
        <aside class="minimum-pro-aside" aria-labelledby="minimum-pro-aside-h">
            ...
            <h2 id="minimum-pro-aside-h" class="minimum-pro-aside__heading"><?php esc_html_e('Unlock every PRO feature', 'sojlo'); ?></h2>
            ...
            <?php if ($price !== '') : ?>
                <p class="minimum-pro-aside__price"><?php echo esc_html($price); ?><?php if ($this->sellable()) : ?> &middot; <?php esc_html_e('one licence, every PRO feature', 'sojlo'); ?><?php endif; ?></p>
            <?php endif; ?>
        </aside>
        <?php
    }
    ...
    public function cards(): void
    {
        ...
        <section class="minimum-pro-cards" aria-labelledby="minimum-pro-cards-h">
            <h2 id="minimum-pro-cards-h" class="minimum-pro-cards__title">
                <?php
                /* translators: %s: PRO edition name */
                printf(esc_html__('What %s adds', 'sojlo'), esc_html($name)); ?>
            </h2>
