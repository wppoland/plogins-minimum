...
return [
    ...
    'features'   => [
        ...
        [
            'en' => ['title' => 'Scheduled rules', 'desc' => 'Activate or relax quantity rules and minimum order totals over a date range on WooCommerce > Sojlo Schedules.'],
            'pl' => ['title' => 'Reguły harmonogramowane', 'desc' => 'Włączaj lub luzuj reguły ilości i minimalną wartość zamówienia w zakresie dat na ekranie WooCommerce > Sojlo Schedules.'],
        ],
        [
            'en' => ['title' => 'Bulk import', 'desc' => 'Import per-product min, max and step overrides from CSV on WooCommerce > Sojlo Bulk Import.'],
            'pl' => ['title' => 'Import zbiorczy', 'desc' => 'Importuj nadpisania min, max i krok per produkt z CSV na ekranie WooCommerce > Sojlo Bulk Import.'],
        ],
        [
            'en' => ['title' => 'Conditional rules', 'desc' => 'Apply rules only when the cart matches a subtotal, item-count, product-ID or category-ID condition on WooCommerce > Sojlo Conditions.'],
            'pl' => ['title' => 'Reguły warunkowe', 'desc' => 'Stosuj reguły tylko gdy koszyk pasuje do warunku subtotalu, liczby sztuk, ID produktu lub ID kategorii - ekran WooCommerce > Sojlo Conditions.'],
        ],
    ],
];
